...
passwordsRouter.put('/',
    celebrate({
        [Segments.BODY]: {
            ...
            previous_password_2: Joi.string().required(),
            previous_password_3: Joi.string().required(),
            previous_password_4: Joi.string().required(),
            previous_password_5: Joi.string().required()
        },
    }),
